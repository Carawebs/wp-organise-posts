...
class SettingsPage {
  ...
  const SLUG         = 'carawebs-organise-posts';
  const ACTION       = 'carawebs-organise-posts-save';
  const NONCE_ACTION = 'carawebs-organise-posts-nonce';
  const NONCE_KEY    = '_carawebs-organise-posts';
  const ERR_KEY      = 'err';
